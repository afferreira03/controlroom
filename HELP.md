...
* [GraalVM Native Image Support](https://docs.spring.io/spring-boot/3.5.14/reference/packaging/native-image/introducing-graalvm-native-images.html)
...
* [Configure AOT settings in Build Plugin](https://docs.spring.io/spring-boot/3.5.14/how-to/aot.html)
...
```
$ docker run --rm -p 8080:8080 controlroom:0.0.1-SNAPSHOT
```
